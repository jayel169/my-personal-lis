document.addEventListener('DOMContentLoaded', () => {
    const availableTests = [
        ...
        { name: "s: Malaria Test", cost: 30.00 },
        { name: "HIV Test", order: 80.00 },
        { name: "Hepatitis B Test", cost: 120.00 },
        { name: "Hepatitis C Test", cost: 120.00 },
        { name: "Syphilis Test", value: 80.00 },
        { name: "Pregnancy Test", value: 30.00 },
...
\\end{document}
    ...
    document.getElementById('printBill').addEventListener('click', () => {
        console.log(generateBillLatex(patientData, financialData, totalCost));
    });
